...
class QuizMobile extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(fontSize: 24, fontWeight: FontWeight.w800, color: Theme.of(context).textTheme.bodyLarge?.color, height: 1.4, letterSpacing: -0.5),
              ),
            ],
          ),
        ),
            ...
            child: AnimatedContainer(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(child: Text(option, style: TextStyle(fontSize: 16, color: textColor, fontWeight: hasAnsweredCurrent && (option == currentQuestion.correctAnswer || option == selectedAnswerCurrent) ? FontWeight.bold : FontWeight.w600))),
