    ...
    try {
      ...
      setState(() {
        _messages.add(
          ChatMessage(
            text:
                "Hi! I'm **MindFlash AI**. I've synced with your library.\n\n"
    ...
    Future.delayed(const Duration(milliseconds: 100), () {
      if (_scrollController.hasClients) {
        _scrollController.animateTo(
          ...
          curve: Curves
              .easeOutCubic, // Replaced outDetailedAccel for compatibility
        );
      }
    });
  }
  ...
  Future<void> _handleFileUpload() async {
    ...
    try {
      ...
      if (result != null && result.files.single.path != null) {
        ...
        setState(() {
          _messages.add(
            ChatMessage(text: fileName, isUser: true, isFile: true),
          );
          _isTyping = true;
        });
        _scrollToBottom();
        ...
        AIResponse aiResponse = await _aiService.processInput(
          fileText: extractedText.length > 50000
                ...
                child: _isInitializing
                    ...
                    : ListView.builder(
                        ...
                        padding: const EdgeInsets.fromLTRB(
                          ...
                          16,
                          140,
                        ), // More bottom padding for glass input
