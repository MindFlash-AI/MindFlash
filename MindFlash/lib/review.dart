...
class _ReviewScreenState extends State<ReviewScreen> {
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: AnimatedSwitcher(
                              ...
                              child: _showAnswer ? _buildBackSide() : _buildFrontSide(),
                            ),
                          ),
                        ),
                        ...
                        Positioned(
                          ...
                          child: IconButton(
                            ...
                            color: _currentIndex < _reviewCards.length - 1 ? Colors.black87 : Colors.black26,
                            onPressed: _currentIndex < _reviewCards.length - 1 ? _nextCard : null,
                          ),
                        ),
                      ],
                    ),
  ...
  Widget _buildProgressBar() {
    double progress = _reviewCards.isEmpty ? 0 : (_currentIndex + 1) / _reviewCards.length;
    return Container(
      height: 6,
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: const Text(
              "QUESTION",
              style: TextStyle(color: Color(0xFF5A6DFF), fontSize: 12, fontWeight: FontWeight.bold),
            ),
          ),
          const Spacer(),
          Text(
            ...
            style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.black87, height: 1.4),
          ),
          const Spacer(),
          const Text("Tap to reveal answer", style: TextStyle(color: Colors.black38, fontSize: 14)),
        ],
      ),
    );
  }
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: const Text(
              "ANSWER",
              style: TextStyle(color: Color(0xFFC042E6), fontSize: 12, fontWeight: FontWeight.bold),
            ),
          ),
          const Spacer(),
          Text(
          ...
          const Spacer(),
          const Text("Tap to flip back", style: TextStyle(color: Colors.black38, fontSize: 14)),
        ],
      ),
    );
  }
