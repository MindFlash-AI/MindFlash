...
class LocalQuizEngine {
  ...
  static List<QuizQuestion> generateMCQ(List<Flashcard> deck) {
    ...
    for (int i = 0; i < deck.length; i++) {
      ...
      String correctAnswer = currentCard.answer; // Assuming your model uses 'answer', not 'back'
      ...
      List<Map<String, dynamic>> scoredAnswers = allWrongAnswers.map((wrongAnswer) {
      ...
      List<String> topTrickiest = scoredAnswers.take(5).map((e) => e['answer'] as String).toList();
      ...
      quiz.add(QuizQuestion(
        question: currentCard.question, // Assuming 'question' instead of 'front'
